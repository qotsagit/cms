...
CKEDITOR.plugins.add( 'widgetbootstrap', {
    ...
    icons: 'widgetbootstrapLeftCol,widgetbootstrapPortfolio,widgetbootstrapRightCol,widgetbootstrapTwoCol,widgetbootstrapThreeCol,widgetbootstrapAlert',
    ...
    init: function( editor ) {
        ...
        editor.widgets.add( 'widgetbootstrapPortfolio', {

            button: showButtons ? 'Add portfolio box' : undefined,

            template:
            '<div class="row two-col-portfolio">' +
                '<div class="col-main col-sm-8">' +
				    '<p>Opis</p>' +								
				'</div>' +
                '<div class="col-sidebar col-sm-4">' +
				    '<ul class="check-list blue">' +
						'<li>Technologia RWD</li>' +
            ...
            upcast: function( element ) {
                return element.name == 'div' && element.hasClass( 'two-col-portfolio' );
            }
