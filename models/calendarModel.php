...
class calendarModel extends Model
{
	...
	{
		return $this->DB->Count('SELECT * FROM calendar', NULL);
	}
	...
	{
		$sql = 'SELECT name as title, start_date as start, end_date as end,text  FROM calendar LIMIT 1000';
		return $this->DB->Query($sql, NULL, PDO::FETCH_ASSOC);
	}
